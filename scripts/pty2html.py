...
pre{{margin:0;color:{FG};font:15px/1.3 'JetBrains Mono','JetBrainsMono Nerd Font','Noto Sans Mono CJK SC','Noto Sans CJK SC',monospace;font-variant-ligatures:none;white-space:pre}}
