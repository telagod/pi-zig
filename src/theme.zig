...
pub const Palette = struct {
    ...
    pub const dark = Palette{
        .user_bg = hex(0x343541),
        .tool_pending = hex(0x282832),
        .tool_ok = hex(0x283228),
        .tool_err = hex(0x3c2828),
        .ok_fg = hex(0xb5bd68),
        .err_fg = hex(0xcc6666),
        ...
        .md_code = hex(0x8abeb7),
        .md_code_block = hex(0xb5bd68),
        .md_code_border = hex(0x505050),
        .md_quote = hex(0x808080),
        .md_quote_border = hex(0x505050),
        .md_hr = hex(0x505050),
        .md_list = hex(0xb5bd68),
    };
